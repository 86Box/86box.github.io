...
The latest stable version of 86Box is **v5.3**, which was released on December 21, 2025, and is available from our [GitHub repository](https://github.com/86Box/86Box/releases/latest). A beta preview of **v6.0** is [available](https://github.com/86Box/86Box/releases/tag/v6.0-beta).
