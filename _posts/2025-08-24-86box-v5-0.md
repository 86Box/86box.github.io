...
Inserting **DVD-ROM discs** (or folders larger than 1 GB) now requires [setting a drive model](//86box.readthedocs.io/en/v5.0/settings/floppycdrom.html#cd-rom-drives) with DVD-ROM support, such as the **86BOX 86B_DVD**, unlike previous versions where all drives accepted all disc types.
...
* Added [**keyboard indicator lights**](//86box.readthedocs.io/en/v5.0/usage/statusbar.html#num-lock-off-caps-lock-off-scroll-lock-off-keyboard-indicators) and **refresh rate indicator** to the status bar
...
* Added translations: <span class="emoji">🇳🇱</span> **Dutch** by [sharkbyte16](//github.com/sharkbyte16), <span class="emoji">🇳🇴</span> **Norwegian (Bokmål)** by [elislays08](//github.com/elislays08), <span class="emoji">🇸🇪</span> **Swedish** by toshineon
...
* **808x**
  * Added 8088 machines: **Atari PC 3**, **Tulip PC Compact 2**, **VTech Laser Turbo XT**
  * Added 8086 machines: **Amstrad PC5086**, **Mazovia 1016**, **VTech Laser XT3**
  ...
  * Added [GLaBIOS](//glabios.org/) option to the **Juko ST** and **Vendex HeadStart Turbo 888-XT**
...
* **Sound**
  ...
  * Added [**Mindscape Music Board**](//www.youtube.com/watch?v=Eeo4INoGyRY) ISA sound card
