...
The work-in-progress build currently available to our [**Patreon supporters**](//www.patreon.com/86box) will be updated soon. We have a **new Patreon preview** in our roadmap for the coming months, replacing the Local Switch which will receive a public release, so stay tuned.
...
As with any hardware of this era, there are many potential gotchas to account for when configuring the modem, all described in the [documentation](//86box.readthedocs.io/en/v4.2/hardware/network.html#modem).
...
* Added translation: <span class="emoji">🇻🇳</span> **Vietnamese** by [Barnacl437](//github.com/Barnacl437)
...
* **Other**
  ...
  * Added [**Novell NetWare 2.x Key Card**](//www.os2museum.com/wp/unlocking-netware-2-0a/) device
