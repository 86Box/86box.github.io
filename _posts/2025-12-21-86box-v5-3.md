...
* **686**
  ...
  * Changed default **ABIT BX6** BIOS back to the EG version
...
* **Ports**
  * Added **Windows named pipe client** mode to serial passthrough
