...
layout: post
title: "Help needed!"
description: "We need help in developing this emulator."
authors: ["OBattler"]
image: "/assets/images/helpneeded/hero.png"
---

{% include imageheading.html url="/assets/images/helpneeded/hero.png" separator=" " %}
...
Lastly, we are in desperate need of funds to guarantee continued support of the macOS platform for 86Box - specifically, we need a second Mac that someone in our team could use to test and maintain the macOS builds.
