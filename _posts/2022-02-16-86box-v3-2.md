...
**IMPORTANT UPDATE #2:** Still on Linux, [**86Box v3.2.1**](https://github.com/86Box/86Box/releases/tag/v3.2.1) should fix the issue with mouse capture dropping the emulation speed down to 0%.
