---
layout: post
title: "86Box v6.0 Beta"
description: "Preview release for May 2026."
authors: ["richardg867"]
image: "/assets/images/v6.0/hero-beta.png"
---

{% include imageheading.html url="/assets/images/v6.0/hero-beta.png" separator=" " %}
...
* Added translation: <span class="emoji">🇬🇷</span> **Greek** by [DimMan88](https://github.com/DimMan88)
...
* **Sound**
  ...
  * Added [**Nuked OPL2 Lite**](https://github.com/nukeykt/Nuked-OPL2-Lite) for more accuracy over the previous Nuked OPL3-based OPL2 emulation
...
* **Storage**
  ...
  * Added **physical hard disk support** through [manual configuration](https://86box.readthedocs.io/en/v6.0/settings/hdd.html#using-physical-disks)
