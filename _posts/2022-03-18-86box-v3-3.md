...
This is the March 2022 update to 86Box, bringing overall bugfixes and some new hardware. As always, you can [download 86Box v3.3 from GitHub](//github.com/86Box/86Box/releases/tag/v3.3).
...
* Added [**Vendex HeadStart Turbo 888-XT**](//www.youtube.com/watch?v=VhDmYhopMgA "As seen on LGR") XT clone
