...
Happy holidays. We hope you're enjoying the season. As a gift, we're releasing [**86Box v3.1**](//github.com/86Box/86Box/releases/tag/v3.1), a bugfix update fixing many of the issues reported after the release of v3.0 earlier this month.
...
* **Display**
  ...
  * Fixed some **S3 ViRGE/GX** and **Trio3D/2X** identification registers
* **Input**
